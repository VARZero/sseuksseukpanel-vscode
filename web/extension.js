...
class SseukSseukPanel {
    constructor(_extensionUri) {
        ...
        this._charsize = sspSettings.charSize;
        this._inputDelayTime = sspSettings.inputDelayTime;
...
function canvPM(e){
    ...
    nowStatus.ctx.strokeStyle = elemC.slice(0, -1) +","+String(1/*e.pressure.toFixed(1)*/)+")";
